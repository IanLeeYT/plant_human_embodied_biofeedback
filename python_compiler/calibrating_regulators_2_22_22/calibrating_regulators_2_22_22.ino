...
void loop() {
  ...
  while( PotOnOffVal == HIGH ){
    ...
    //v=8
    regval1 = (255/25)*C*(.382*cos(2*pi*(elapsedtime-2)*.14 * freq_factor)+.758*cos(2*pi*(elapsedtime-2)*.2 * freq_factor)+.269*cos(2*pi*(elapsedtime-2)*.24 * freq_factor)+.332*cos(2*pi*(elapsedtime-2)*.28 * freq_factor)+.064*cos(2*pi*(elapsedtime-2)*.48 * freq_factor)+bias);
    regval2 = (255/25)*C*(.382*cos(2*pi*(elapsedtime)*.14 * freq_factor)+.758*cos(2*pi*(elapsedtime)*.2 * freq_factor)+.269*cos(2*pi*(elapsedtime)*.24 * freq_factor)+.332*cos(2*pi*(elapsedtime)*.28 * freq_factor)+.064*cos(2*pi*(elapsedtime)*.48 * freq_factor)+bias);
    ...
    analogWrite(press_reg1, min(pmx, int(regval1)));
    analogWrite(press_reg2, min(pmx, int(regval2)));
